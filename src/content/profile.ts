...
export const profileContent: Record<Locale, ProfileContent> = {
  pt: {
    ...
    summary:
      "Tecnico de IT junior com experiencia pratica em suporte tecnico, onboarding e configuracao de ambientes Windows. Atualmente a aprofundar desenvolvimento de software com foco em C#, SQL, Next.js e Supabase.",
    ...
    skills: {
      ...
      languages: ["C# (intermedio)", "SQL (intermedio)", "C++ (basico)", "JavaScript"],
  ...
  en: {
    ...
    skills: {
      ...
      languages: ["C# (intermediate)", "SQL (intermediate)", "C++ (basic)", "JavaScript"],
      webAndCloud: ["Next.js", "Supabase", "Firebase", "Vercel", "HTML5", "CSS3"],
      tools: ["Git & GitHub", "VS Code", "Microsoft 365"],
